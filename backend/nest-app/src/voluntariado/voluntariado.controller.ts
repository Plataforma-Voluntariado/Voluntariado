import {
  Controller, Get, Post, Body, Param, Delete, Req, UseGuards, Put, UploadedFiles, UseInterceptors, BadRequestException} from '@nestjs/common';
...
export class VoluntariadoController {
  ...
  async update(@Param('id') id: string,@Body() body: any,@UploadedFiles() nuevasFotos: Express.Multer.File[],@Req() req: any) {
    ...
    return this.voluntariadoService.update(+id, dto, req.user, nuevasFotos);
  }
